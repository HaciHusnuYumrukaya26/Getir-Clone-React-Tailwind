...
function HeroSection() {
  ...
  return (
    <div className="  bg-purple-500 relative  ">
          ...
          <div
            className=" bg-center bg-no-repeat bg-cover h-[350px]"
            style={{
              backgroundImage:
                "url(https://getir.com/_next/static/images/bimutluluk-b3a7fcdcb14fc9a9c09b60d7dc9b1b8fd6.svg)",
            }}
          ></div>

      <div className=" m-5   sm:absolute inset-0 px-0 sm:px-8 z-[40] flex items-center">
